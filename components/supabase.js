...
// ═══════════════════════════════════════════════════════════════
// Dépend de :
// - window.SUPABASE_CONFIG (défini dans config.js)
// - window.supabase (lib chargée via CDN dans index.html)
// ═══════════════════════════════════════════════════════════════

(function () {
  const cfg = window.SUPABASE_CONFIG || {};
  if (!cfg.url || cfg.url.includes('VOTRE-PROJET')) {
    console.warn('[Supabase] Config manquante. Remplissez components/config.js avec vos clés Supabase.');
    window.SB = null;
    return;
  }
  if (!window.supabase || !window.supabase.createClient) {
    console.error('[Supabase] Librairie non chargée (@supabase/supabase-js).');
    window.SB = null;
    return;
  }
  ...
  // Expose
  // ─────────────────────────────────────────
  window.SB = { client, auth, db, realtime };
