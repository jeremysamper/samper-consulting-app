...
const mcs = {
  ...
  printTop: { display: 'flex', justifyContent: 'space-between', gap: 20, borderBottom: '2px solid #92702A', paddingBottom: 18, marginBottom: 24 },
  printEyebrow: { fontSize: 11, letterSpacing: 1.2, textTransform: 'uppercase', color: '#92702A', fontWeight: 700 },
  ...
  printGroupTitle: { fontFamily: 'Georgia, serif', fontSize: 19, color: '#92702A', margin: '0 0 10px', borderBottom: '1px solid #e7dfcf', paddingBottom: 5 },
  ...
  printAllergenes: { fontSize: 10, color: '#92702A', marginTop: 4, fontWeight: 600 },
