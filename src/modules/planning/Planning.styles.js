...
const pls = {
  ...
  exportBtn: { padding: '8px 14px', background: 'var(--surface)', borderWidth: 1, borderStyle: 'solid', borderColor: 'var(--border)', color: 'var(--text2)', borderRadius: 8, fontSize: 13, cursor: 'pointer', fontFamily: 'var(--font)' },
  ...
  mobileCard: { position: 'relative', display: 'flex', alignItems: 'stretch', background: 'var(--surface)', borderWidth: 1, borderStyle: 'solid', borderColor: 'var(--border)', borderRadius: 12, overflow: 'hidden', cursor: 'pointer', minHeight: 44 },
