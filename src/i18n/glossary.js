...
export const UI_GLOSSARY = {
  ...
  'Mariages, anniversaires, séminaires, groupes et apéros dînatoires':
    'Weddings, birthdays, seminars, groups and cocktail receptions',
  'Mariage': 'Wedding',
  'Anniversaire': 'Birthday',
  'Séminaire': 'Seminar',
  'Apéro dînatoire': 'Cocktail reception',
  'À lire': 'To read',
  'Lu, à préparer': 'Read, to prepare',
  'Prêt': 'Ready',
  'Pas encore lu par la brigade': 'Not yet read by the team',
  'Lu, pas encore préparé': 'Read, not yet prepared',
  'Lu et préparé': 'Read and prepared',
  'Pas encore lu par la brigade.': 'Not yet read by the team.',
  'Tout est lu et préparé.': 'Everything is read and prepared.',
  'Fiche': 'Sheet',
  ...
  'Client ou nom du groupe': 'Client or group name',
  'Nombre de personnes': 'Number of guests',
  'Contact (téléphone ou e-mail)': 'Contact (phone or email)',
  'Contact': 'Contact',
  'Allergies': 'Allergies',
  'Allergies et régimes': 'Allergies and diets',
  'Modifications du menu': 'Menu changes',
  'Menu à définir.': 'Menu to be decided.',
  'Menu à définir : tu pourras le choisir plus tard.': 'Menu to be decided: you can pick it later.',
  'À composer.': 'To be composed.',
  'Composer': 'Compose',
  'Composition': 'Composition',
  'Intitulé du menu': 'Menu title',
  'Présentation': 'Introduction',
  'Prix par personne (CHF)': 'Price per guest (CHF)',
  'par personne': 'per guest',
  'Ajouter un plat': 'Add a dish',
  'Ajouter un groupe ce jour-là': 'Add a group on that day',
  'Plat hors carte (texte libre)': 'Off-menu dish (free text)',
  'Mois précédent': 'Previous month',
  'Mois suivant': 'Next month',
  'Apéritif': 'Aperitif',
  'Pièces froides': 'Cold canapés',
  'Pièces chaudes': 'Hot canapés',
  'Pièces sucrées': 'Sweet canapés',
  'Fromage': 'Cheese',
